...
import { Plane, Luggage, CreditCard, ArrowLeft, Loader2 } from "lucide-react";
...
export function BookingReviewPage() {
  ...
  // Load booking + passenger data from session storage
  useEffect(() => {
...
// ✅ Default export for routing and imports
